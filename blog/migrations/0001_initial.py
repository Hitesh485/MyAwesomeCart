    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_content0', models.CharField(default='', max_length=5000)),
                ('head1', models.CharField(default='', max_length=500)),
                ('head_content1', models.CharField(default='', max_length=5000)),
                ('head2', models.CharField(default='', max_length=500)),
                ('head_content2', models.CharField(default='', max_length=5000)),
